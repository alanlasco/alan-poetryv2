  ...
  return (
    <>
      <div className="brandContainer">
        <p className="brand">ALAN X. LASCO</p>
      </div>
      <nav className="nav">
        <ul className={active}>
          <li
          ...
          <li
            onClick={() => setPaginaActiva("poemario")}
            className={
              paginaActiva === "poemario" ? "nav-item activo" : "nav-item"
            }
          >
            <Link to="/poemario">Poemario</Link>
          </li>
          <li
            onClick={() => setPaginaActiva("sobremi")}
            className={
          ...
          <li
            onClick={() => setPaginaActiva("contacto")}
            className={
